...
export default function Home() {
  return (
    <main className="min-h-screen">
      {/* Hero Section */}
      <section className="relative min-h-screen flex flex-col items-center justify-center text-center px-3 sm:px-4 py-16 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-primary/20 via-background to-background">
        <div className="space-y-6 sm:space-y-8">
          <Image
            ...
            width={150}
            height={75}
            className="mx-auto rounded-lg sm:w-[200px]"
          />
          <div>
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-3 sm:mb-4 bg-clip-text text-transparent bg-gradient-to-r from-primary to-primary/80 leading-tight">
              International Conference by Indonesian Students in Korea (ICONIK) 2025
            </h1>
            <div className="flex items-center gap-1 sm:gap-2 justify-center text-lg sm:text-xl md:text-2xl mb-6 sm:mb-8 text-muted-foreground/80">
      ...
      {/* About Us Section */}
      <section id="about" className="py-12 sm:py-20 px-3 sm:px-4 bg-white scroll-mt-16">
      ...
      {/* Objectives Section */}
      <section className="py-12 sm:py-20 px-3 sm:px-4 bg-gray-50">
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center gap-2 sm:gap-3 justify-center mb-6 sm:mb-8">
            <div className="p-2 bg-primary/10 rounded-full">
              <Target className="h-6 w-6 text-primary" />
            </div>
            <h2 className="text-2xl sm:text-3xl font-semibold">Objectives</h2>
          </div>
      ...
      <section className="py-12 sm:py-20 px-3 sm:px-4 bg-white">
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center gap-2 sm:gap-3 justify-center mb-6 sm:mb-8">
            ...
            <h2 className="text-2xl sm:text-3xl font-semibold">Venue and Accommodation</h2>
          </div>
      ...
      {/* Topics Section */}
      <section id="topics" className="py-12 sm:py-20 px-3 sm:px-4 bg-white scroll-mt-16">
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center gap-2 sm:gap-3 justify-center mb-6 sm:mb-8">
            <div className="p-2 bg-primary/10 rounded-full">
              <BookOpen className="h-6 w-6 text-primary" />
            </div>
            <h2 className="text-2xl sm:text-3xl font-semibold">Conference Topics</h2>
          </div>
          <div className="grid gap-6">
            <Card className="p-6 md:p-8 shadow-md">
              <div className="space-y-6">
      ...
      <section id="registration" className="py-12 sm:py-20 px-3 sm:px-4 bg-gray-50 scroll-mt-16">
        <div className="max-w-5xl mx-auto">
          <div className="flex items-center gap-2 sm:gap-3 justify-center mb-6 sm:mb-8">
            <div className="p-2 bg-primary/10 rounded-full">
              <CreditCard className="h-6 w-6 text-primary" />
            </div>
            <h2 className="text-2xl sm:text-3xl font-semibold">Registration Fee</h2>
          </div>
          <Card className="p-6 md:p-8 shadow-md">
            <div className="space-y-6">
      ...
      <section id="keynote" className="py-12 sm:py-20 px-3 sm:px-4 bg-white scroll-mt-16">
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center gap-2 sm:gap-3 justify-center mb-6 sm:mb-8">
            <div className="p-2 bg-primary/10 rounded-full">
              <Mic className="h-6 w-6 text-primary" />
            </div>
            <h2 className="text-2xl sm:text-3xl font-semibold">Keynote Speakers</h2>
          </div>
          <div className="grid md:grid-cols-2 gap-6">
            <Card className="p-6 md:p-8 shadow-md">
              <div className="space-y-4">
      ...
      <section className="py-12 sm:py-20 px-3 sm:px-4 bg-gray-50">
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center gap-2 sm:gap-3 justify-center mb-6 sm:mb-8">
            ...
            <h2 className="text-2xl sm:text-3xl font-semibold">Committee</h2>
          </div>
          <Card className="p-6 md:p-8 shadow-md">
            <ul className="space-y-4">
              <li className="flex flex-col sm:flex-row sm:gap-2">
                <span className="font-semibold sm:min-w-[120px]">Director:</span>
              ...
              <li className="flex flex-col sm:flex-row sm:gap-2">
                <span className="font-semibold sm:min-w-[120px]">Vice Director:</span>
