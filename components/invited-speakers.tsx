...
const invitedSpeakersData = [
  {    
    name: "Prof. Sang-Ho Song",
    title: "Gyeongguk National University",
    theme: "Departement of Educational Technology",
    image: "/invited1.png", // Placeholder
    day: "Day 1"
  },
  {
    name: "Prof. Lim Ock Taeck",
    title: "University of Ulsan",
    theme: "Departement of Mechanical Engineering",
    image: "/invited2.png", // Placeholder
    day: "Day 1"
  },
  {
    name: "Prof. Hyung-Jun Kim",
    title: "Kangwon National University",
    theme: "Departement of Cultural Anthropology",
    image: "/invited3.jpg", // Placeholder
    day: "Day 1"
  }
]
    ...
    <section id="keynote" className="py-8 sm:py-12 md:py-20 px-2 sm:px-4 bg-white scroll-mt-16">
      <div className="max-w-6xl mx-auto">
        <div className="flex items-center gap-2 sm:gap-3 justify-center mb-6 sm:mb-8">
          ...
          <h2 className="text-xl sm:text-2xl md:text-3xl font-semibold">Invited Speakers</h2>
        </div>
