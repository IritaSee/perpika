...
const keynoteSpeakersData = [
  ...
  {
    name: "Indonesia Embassy in ROK",
    title: "Educational and Cultural Attache of Indonesia in ROK",
    theme: "Role of Students in Strengthening Academic Diplomatic through Science and Culture Exchange",
    image: "/indonesia_embassy.png", // Placeholder
    day: "Day 1"
  },
  {
    name: "WHO Indonesia",
    title: "WHO Indonesia",
    theme: "Integrating Student Initiatives in Stunting Prevention: A Path to Global Prosperityrgy's Industry",
    image: "/who.png", // Placeholder
    day: "Day 2"
  },
  {
    name: "Prof. Dr. Zainudin Amali, S.E., M.Si",
    title: "Minister of Youth and Sports of Indonesia 2019-2023",
    ...
    image: "/adam_lukman.png", // Placeholder
    day: "Day 2"
  },
  {
    ...
    title: "TBA",
    theme: "TBA",
    image: "/special_guest.png", // Placeholder
    day: "Day 1"
  }
]
    ...
    <section id="keynote" className="py-8 sm:py-12 md:py-20 px-2 sm:px-4 bg-white scroll-mt-16">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="space-y-6 sm:space-y-8">
          ...
          <div>
            <h3 className="text-lg sm:text-xl font-semibold mb-3 sm:mb-4 text-center">Day 2</h3>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
              {keynoteSpeakersData
                .filter((speaker) => speaker.day === "Day 2")
                .map((speaker) => (
                <AnimatedCard key={speaker.name}>
                  <div className="flex flex-col h-[350px] sm:h-[400px]">
                    <div className="aspect-square relative bg-muted rounded-md sm:rounded-lg overflow-hidden flex items-center justify-center">
